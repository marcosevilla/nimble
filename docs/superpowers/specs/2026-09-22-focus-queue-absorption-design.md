...
| Suspension gap (no sleep/wake pair) | Use last durable checkpoint; pause work or break. A heartbeat after a sleep notice waits up to three ticks for the wake notice before applying this rule; commands never wait. | Wake/relaunch requires Resume; recovery explanation. |
