...
**Source:** `daily-triage/apps/desktop/src/components/pages/TodayPage.tsx`, `daily-triage/apps/desktop/src/components/layout/Dashboard.tsx`, `daily-triage/apps/desktop/src/components/shared/PageHeader.tsx`, `daily-triage/apps/desktop/src/components/calendar/CalendarPanel.tsx`, `daily-triage/apps/desktop/src/components/shared/HelpPanel.tsx`, `daily-triage/apps/desktop/src/index.css`.
...
- **Severity:** minor
- **File:** `daily-triage/apps/desktop/src/index.css:120-122` (`body { @apply bg-background text-foreground; }`)
...
- **Severity:** polish
- **File:** `daily-triage/apps/desktop/src/components/pages/TodayPage.tsx:237-240` (ReviewMode greeting block).
...
- **Severity:** minor
- **File:** `daily-triage/apps/desktop/src/components/pages/TodayPage.tsx:104-116` (`ReviewStep` wrapper `rounded-lg p-4` + inner `size-6 rounded-full` step badge).
...
- **Severity:** polish
- **File:** `daily-triage/apps/desktop/src/components/pages/TodayPage.tsx:104-127` (`active && 'animate-in fade-in slide-in-from-bottom-2 duration-200'`).
...
- **Severity:** polish
- **File:** `daily-triage/apps/desktop/src/components/ui/button.tsx:9` (base `buttonVariants` class) — affects the `Next` button at `TodayPage.tsx:263-265`.
...
- **Severity:** minor
- **File:** `daily-triage/apps/desktop/src/components/ui/button.tsx:9` (`... whitespace-nowrap transition-all outline-none ...`).
...
- **Severity:** minor
- **File:** `daily-triage/apps/desktop/src/components/shared/HelpPanel.tsx:181` (`'fixed bottom-4 right-4 z-30 flex size-9 ...'`).
...
- **Severity:** polish
- **File:** `daily-triage/apps/desktop/src/components/calendar/CalendarPanel.tsx:491-498` (error branch with "Could not load calendar" + Retry button).
...
- **Severity:** polish
- **File:** `daily-triage/apps/desktop/src/components/pages/TodayPage.tsx:237-240` (greeting block) inside `animate-page-enter` (`Dashboard.tsx:223`).
...
- **Severity:** polish
- **File:** `daily-triage/apps/desktop/src/components/shared/PageHeader.tsx:43-53` (title + meta row).
