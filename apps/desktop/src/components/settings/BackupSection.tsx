...
function backupMessage(code: unknown): string {
  const messages: Record<string, string> = {
    ...
    unrelated_backup_repository: 'The backup folder belongs to another repository. Your files were kept.',
    unexpected_backup_files: 'Unexpected files in the backup folder. Move them out, then try again. Your files were kept.',
