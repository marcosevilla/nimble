...
const INPUT_VARIANTS: Record<FieldVariant, string> = {
  ...
  ghost: "field-ghost placeholder:text-muted-foreground-subtle",
}
...
function Input({
  ...
  return (
    <InputPrimitive
      ...
      className={cn(
        "w-full min-w-0 text-body transition-colors file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-body file:text-foreground placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
