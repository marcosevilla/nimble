...
export const SHORTCUTS: Shortcut[] = [
  ...
  { section: 'Tasks', keys: 'p', label: 'Set priority of the focused task' },
  { section: 'Tasks', keys: '⇧D', label: 'Set due date of the focused task' },
  { section: 'Tasks', keys: 'l', label: 'Edit labels of the focused task' },
